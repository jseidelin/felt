...
module.exports = function convolve3x3(src, options) {
    ...
    const k00 = kernel[0][0]; const k01 = kernel[0][1]; const k02 = kernel[0][2];
    const k10 = kernel[1][0]; const k11 = kernel[1][1]; const k12 = kernel[1][2];
    const k20 = kernel[2][0]; const k21 = kernel[2][1]; const k22 = kernel[2][2];
